...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--twin_esu_num_layers', type=int, default=1,
                        help='H034: number of ESU MultiheadAttention layers '
                             '(1 = H019 byte-identical, 2 = H034 stacked with '
                             'intermediate residual + LayerNorm).')
...
def main() -> None:
    ...
    model_args = {
        ...
        # H034 — ESU multi-layer
        "twin_esu_num_layers": args.twin_esu_num_layers,
    }
