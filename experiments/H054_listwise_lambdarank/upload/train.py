...
def parse_args() -> argparse.Namespace:
    ...
    # H051 — LambdaRank-lite listwise pairwise loss
    parser.add_argument('--lambdarank_lambda', type=float, default=0.0,
                        help='H051: LambdaRank-lite auxiliary loss weight. 0.0 → off (H019 byte-identical). '
                             'Lambda-weighted pairwise (focus on misranked pairs).')
...
def main() -> None:
    ...
    trainer = PCVRHyFormerRankingTrainer(
        ...
        lambdarank_lambda=args.lambdarank_lambda,    # H051
