...
def parse_args() -> argparse.Namespace:
    ...
    # H056 — Concat-input classifier
    parser.add_argument('--use_concat_clsfier', action='store_true', default=False,
                        help='H056: enable concat-input classifier. clsfier input dim 2*d_model = '
                             'concat(output, item_repr=item_ns mean). NO residual stacking on output '
                             '(avoids H048 fail mode).')
...
def main() -> None:
    ...
    model_args = {
        ...
        # H056 — Concat-input classifier
        "use_concat_clsfier": args.use_concat_clsfier,
    }
