...
def parse_args() -> argparse.Namespace:
    ...
    # H050 — SimCSE user self-contrastive (SSL via dropout views, paradigm shift)
    parser.add_argument('--use_user_simcse', action='store_true', default=False,
                        help='H050: enable SimCSE-style user self-contrastive on backbone output. '
                             '2 dropout views of user_repr → InfoNCE in-batch.')
    parser.add_argument('--simcse_lambda', type=float, default=0.1,
                        help='H050: SimCSE auxiliary loss weight.')
    parser.add_argument('--simcse_temperature', type=float, default=0.1,
                        help='H050: SimCSE InfoNCE temperature.')
    parser.add_argument('--simcse_dropout', type=float, default=0.1,
                        help='H050: dropout rate for the two SimCSE views.')
...
def main() -> None:
    ...
    model_args = {
        ...
        # H050 — SimCSE user self-contrastive
        "use_user_simcse": args.use_user_simcse,
    }
    ...
    trainer = PCVRHyFormerRankingTrainer(
        ...
        simcse_lambda=args.simcse_lambda,    # H050
        simcse_temperature=args.simcse_temperature,    # H050
        simcse_dropout=args.simcse_dropout,    # H050
