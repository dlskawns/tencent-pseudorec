...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--use_twin_candidate_time', action='store_true', default=False,
                        help='H061: enrich TWIN candidate Q with time signal '
                             '(max time bucket across domains, log1p, projected). '
                             'Affects GSU scoring AND ESU MHA Q (upstream).')
...
def main() -> None:
    ...
    model_args = {
        ...
        # H061 — TWIN candidate time
        "use_twin_candidate_time": args.use_twin_candidate_time,
    }
