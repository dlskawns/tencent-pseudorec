...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--use_dann_cohort', action='store_true', default=False,
                        help='H046: enable separate cohort head + GRL between backbone and cohort_head. '
                             'Cohort head trains positively, backbone gets reversed grad. Fixes H044 design flaw.')
    parser.add_argument('--dann_cohort_lambda', type=float, default=0.1,
                        help='H046: GRL strength (backbone grad scale = -dann_cohort_lambda).')
...
def main() -> None:
    ...
    model_args = {
        ...
        # H046 — proper DANN cohort debias
        "use_dann_cohort": args.use_dann_cohort,
        "dann_cohort_lambda": args.dann_cohort_lambda,
    }
