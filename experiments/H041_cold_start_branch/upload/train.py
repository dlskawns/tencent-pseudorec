...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--use_cold_start_branch', action='store_true', default=False,
                        help='H041: enable dual classifier (main + cold) with learned per-sample gate. '
                             'Data signal: target_in_history=0.4%, 99.6%% extrapolation.')
    parser.add_argument('--cold_start_gate_init', type=float, default=2.0,
                        help='H041: gate bias init (sigmoid(2.0)≈0.88 → main dominates initially).')
...
def main() -> None:
    ...
    model_args = {
        ...
        # H041 — cold-start dual branch
        "use_cold_start_branch": args.use_cold_start_branch,
        "cold_start_gate_init": args.cold_start_gate_init,
    }
