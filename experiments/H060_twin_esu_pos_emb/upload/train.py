...
def parse_args() -> argparse.Namespace:
    ...
    # H060 — TWIN ESU positional embedding for top-K
    parser.add_argument('--use_twin_esu_pos_emb', action='store_true', default=False,
                        help='H060: TWIN ESU adds learnable positional embedding for top-K positions '
                             '(rank-aware ESU MHA). TWIN-internal mutation, single residual preserved.')
...
def main() -> None:
    ...
    model_args = {
        ...
        # H060 — TWIN ESU positional embedding
        "use_twin_esu_pos_emb": args.use_twin_esu_pos_emb,
    }
