...
def parse_args() -> argparse.Namespace:
    ...
    # H062 — TWIN learnable GSU
    parser.add_argument('--use_twin_learnable_gsu', action='store_true', default=False,
                        help='H062: TWIN GSU scoring uses learnable W_q/W_k (low-rank) instead of '
                             'parameter-free inner product. TWIN-internal mutation.')
    parser.add_argument('--twin_gsu_rank', type=int, default=16,
                        help='H062: low-rank dimension for learnable GSU.')
...
def main() -> None:
    ...
    model_args = {
        ...
        # H062 — TWIN learnable GSU
        "use_twin_learnable_gsu": args.use_twin_learnable_gsu,
        "twin_gsu_rank": args.twin_gsu_rank,
    }
