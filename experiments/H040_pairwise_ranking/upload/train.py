...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--loss_type', type=str, default='bce',
                        ...
                        help='Loss type: bce = BCEWithLogits, focal = Focal Loss, '
                             'bpr = H040 pairwise BPR ranking loss (AUC direct optimization).')
    parser.add_argument('--bpr_num_neg', type=int, default=4,
                        help='H040: number of random negatives sampled per positive '
                             'for BPR pairwise loss. Effective only with --loss_type bpr.')
...
def main() -> None:
    ...
    trainer = PCVRHyFormerRankingTrainer(
        ...
        bpr_num_neg=args.bpr_num_neg,    # H040
