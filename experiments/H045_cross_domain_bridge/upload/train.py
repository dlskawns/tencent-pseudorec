...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--use_cross_domain_bridge', action='store_true', default=False,
                        help='H045: enable per-domain encoder output cross-domain attention. '
                             'Mean-pool 4 domain seqs → MultiheadAttention → residual ADD post-backbone.')
    parser.add_argument('--cross_domain_num_heads', type=int, default=4,
                        help='H045: cross-domain attention num_heads.')
    parser.add_argument('--cross_domain_gate_init', type=float, default=-2.0,
                        help='H045: cross-domain bridge gate init (§10.10 sigmoid(-2)≈0.12).')
...
def main() -> None:
    ...
    model_args = {
        ...
        # H045 — Cross-domain bridge attention
        "use_cross_domain_bridge": args.use_cross_domain_bridge,
        "cross_domain_num_heads": args.cross_domain_num_heads,
        "cross_domain_gate_init": args.cross_domain_gate_init,
    }
