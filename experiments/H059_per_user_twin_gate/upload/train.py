...
def parse_args() -> argparse.Namespace:
    ...
    # H059 — Per-user adaptive TWIN gate
    parser.add_argument('--use_per_user_twin_gate', action='store_true', default=False,
                        help='H059: per-user adaptive TWIN gate (sigmoid(Linear(output)), per-sample). '
                             'Replaces scalar twin_gate when active. bias init = twin_gate_init.')
...
def main() -> None:
    ...
    model_args = {
        ...
        # H059 — Per-user adaptive TWIN gate
        "use_per_user_twin_gate": args.use_per_user_twin_gate,
    }
