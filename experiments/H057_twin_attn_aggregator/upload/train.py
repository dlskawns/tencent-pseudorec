...
def parse_args() -> argparse.Namespace:
    ...
    # H057 — TWIN aggregator attention
    parser.add_argument('--use_twin_attn_aggregator', action='store_true', default=False,
                        help='H057: TWIN aggregator uses per-user per-domain attention weights '
                             '(softmax) instead of uniform mean. TWIN-internal mutation, single residual preserved.')
...
def main() -> None:
    ...
    model_args = {
        ...
        # H057 — TWIN aggregator attention
        "use_twin_attn_aggregator": args.use_twin_attn_aggregator,
    }
