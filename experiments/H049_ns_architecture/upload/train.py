...
def parse_args() -> argparse.Namespace:
    ...
    # H049 — NS architecture refinement (slot type embedding)
    parser.add_argument('--use_ns_slot_type_emb', action='store_true', default=False,
                        help='H049: enable learnable NS slot type embedding. 4 types: '
                             'user_ns(0)/user_dense(1)/item_ns(2)/item_dense(3). '
                             'Added per-slot to ns_tokens before backbone.')
...
def main() -> None:
    ...
    model_args = {
        ...
        # H049 — NS architecture refinement
        "use_ns_slot_type_emb": args.use_ns_slot_type_emb,
    }
