...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('--use_user_item_cross', action='store_true', default=False,
                        help='H048: enable explicit user × item bilinear cross at top of backbone. '
                             'cross = user_repr ⊙ (W item_repr), residual ADD post-backbone.')
    parser.add_argument('--user_item_cross_gate_init', type=float, default=-2.0,
                        help='H048: cross gate init (sigmoid(-2.0)≈0.12 §10.10).')
...
def main() -> None:
    ...
    model_args = {
        ...
        # H048 — User × Item bilinear cross
        "use_user_item_cross": args.use_user_item_cross,
        "user_item_cross_gate_init": args.user_item_cross_gate_init,
    }
