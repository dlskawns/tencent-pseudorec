...
class CandidateSummaryToken(nn.Module):
    ...
    def forward(
        ...
        if padding_mask is not None:
            mask_expand = padding_mask.unsqueeze(1).unsqueeze(2)
...
class PCVRHyFormer(nn.Module):
    ...
    def _build_token_streams(
        ...
        # Combined with H008 (DCN-V2 fusion at MultiSeqHyFormerBlock step 3): seq
        # axis (candidate-aware seq) + interaction axis (DCN-V2 polynomial cross)
        # share gradient at block level (§0 P1 direct compliance).
