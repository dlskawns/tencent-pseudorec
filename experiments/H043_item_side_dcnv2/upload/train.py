...
def parse_args() -> argparse.Namespace:
    ...
    # H043 — item-side DCN-V2 cross (item-side feature interaction)
    parser.add_argument('--use_item_side_cross', action='store_true', default=False,
                        help='H043: enable DCN-V2 polynomial cross on item NS tokens '
                             '(item-side feature interaction). Pre-LN, low-rank.')
    parser.add_argument('--item_side_cross_layers', type=int, default=2,
                        help='H043: num cross layers for item-side DCN-V2. '
                             'Effective with --use_item_side_cross.')
    parser.add_argument('--item_side_cross_rank', type=int, default=4,
                        help='H043: low-rank for item-side DCN-V2. '
                             'Effective with --use_item_side_cross.')
...
def main() -> None:
    ...
    model_args = {
        ...
        # H043 — item-side DCN-V2 cross
        "use_item_side_cross": args.use_item_side_cross,
        "item_side_cross_layers": args.item_side_cross_layers,
        "item_side_cross_rank": args.item_side_cross_rank,
    }
